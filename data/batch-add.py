...
songs = df[['music_name', 'singer', 'thumbnail','lyrics']].drop_duplicates().reset_index(drop=True)
songs.rename(columns={'thumbnail': 'external_link','music_name':'title', 'singer':'artist','lyrics':'full_lyrics'}, inplace=True)
songs['id'] = songs.index + 1  # 1-based IDs
...
# Command to add
# \copy songs(title, artist, external_link,full_lyrics,id) FROM '/Users/msagarwal/Desktop/personal/music-filter/data/songs.csv' CSV HEADER
# \copy lyrics(song_id, line_number, lyric_line) FROM '/Users/msagarwal/Desktop/personal/music-filter/data/lyrics.csv' CSV HEADER
